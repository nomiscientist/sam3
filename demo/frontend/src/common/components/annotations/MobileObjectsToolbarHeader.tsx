    ...
    <div className="w-full flex gap-4 items-center px-5 py-5">
      <div className="grow text-sm text-white">
        ...
        {streamingState === 'full'
          ...
          : isStreaming
            ? 'Football players are being tracked throughout the video. Watch closely for any tracking issues.'
            : 'Edit your player selection with a few more clicks if needed. Press "Track players" to track your players throughout the video.'}
      </div>
    </div>
  );
}
